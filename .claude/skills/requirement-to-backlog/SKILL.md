...
6. **ระบุข้อสันนิษฐาน** — ถ้า spec ไม่ระบุ priority หรือ scope ชัดเจน ให้ตั้งสมมติฐานที่สมเหตุสมผลและรวบรวมไว้ในหัวข้อ "## ข้อสันนิษฐาน" ท้ายไฟล์ backlog เพื่อให้ผู้ใช้ตรวจสอบ — ห้ามเดา business rule ที่กระทบ scope ใหญ่โดยไม่ระบุให้เห็น

7. **เคารพกฎของโปรเจกต์**: ห้ามลบเอกสารเดิมโดยตรง (ให้แนะนำย้ายไป `docs/00-archived/` และรอผู้ใช้ยืนยัน), เขียนทุกอย่างเป็นภาษาไทย, เพิ่ม wikilink เชื่อมโยงตามรูปแบบเดิมของโปรเจกต์
